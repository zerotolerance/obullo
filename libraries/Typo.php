...
Class OB_Typo {
     ...
     * @return   string
     */
    public function auto_typo($str, $reduce_linebreaks = FALSE)
    {
        if ($str == '')
        {
            return '';
     ...
     * @return   string
     */    
    public function _format_newlines($str)
    {
        if ($str == '')
        {
            return $str;
     ...
     * @return    string
     */
    public function _protect_characters($match)
    {
...
/* End of file Typo.php */
/* Location: ./obullo/libraries/Typo.php */